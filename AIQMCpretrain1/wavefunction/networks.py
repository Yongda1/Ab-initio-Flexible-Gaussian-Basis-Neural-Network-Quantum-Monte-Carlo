...
from AIQMCpretrain1.wavefunction import jastrows
from AIQMCpretrain1.wavefunction import network_blocks
import jax
...
def make_state_trace(signed_network: AINetLike, n: int) -> AINetLike:
...
def make_total_ansatz(signed_network: AINetLike,
                      n: int,
                      complex_output: bool = False) -> AINetLike:
