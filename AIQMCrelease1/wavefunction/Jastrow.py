...
def _jastrow_ee(ee: jnp.ndarray, params: ParamTree, parallel_indices: jnp.array, antiparallel_indices: jnp.array,
    ...
    #jax.debug.print("Jastrow_r_ees:{}", r_ees)
...
def get_jastrow(jastrow: JastrowType, atom_indices: jnp.array, charges_needed: jnp.array) -> ...:
    jastrow_ee_init, jastrow_ee_apply = make_pade_ee_jastrow()
    jastrow_ae_init, jastrow_ae_apply = make_pade_ae_jastrow(atom_indices=atom_indices, charges_needed=charges_needed)
