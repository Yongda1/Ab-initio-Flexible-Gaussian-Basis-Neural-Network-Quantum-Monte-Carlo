...
import attr
import chex
from AIQMCrelease1.wavefunction_debug import envelopes
from AIQMCrelease1.wavefunction_debug import network_blocks
import jax
...
class OrbitalAILike(Protocol):
    ...
    def __call__(
        ...
        """Forward evaluation of the Neural Network up to the orbitals.
...
def make_orbitals(
  ...
  """
    ...
    def apply(
        ...
        #envelope_factor = jnp.reshape(envelope_factor, (1, nelectrons, nelectrons)) # 1 is the number of dets
        ...
        #orbitals = [orbitals * envelope_factor * diffuse_part * jnp.power(r_effective, exponent_part)]
...
def make_ai_net(
    ...
    equivariant_layers = make_ai_net_layers(nspins, charges.shape[0], options)
