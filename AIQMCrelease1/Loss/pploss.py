...
def make_loss(network: nn.LogAINetLike, local_energy: pphamiltonian.LocalEnergy) -> LossAINet:
    """our local_energy function from hamiltonian module is already batched version.
    We dont need rewrite it here."""
    batch_local_energy = jax.vmap(local_energy, in_axes=(None, 0, nn.AINetData(positions=0, atoms=0, charges=0),
                                                         ), out_axes=(0, 0))
