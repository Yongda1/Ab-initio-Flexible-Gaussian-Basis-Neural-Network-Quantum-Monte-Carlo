...
def local_energy(
  ...
  """
    ...
    def _e_l(
            params: nn.ParamTree, key: chex.PRNGKey, data: nn.AINetData
    ) -> Tuple[jnp.ndarray, Optional[jnp.ndarray]]:
    ...
    """
        if states:
            # Compute features
            vmap_features = jax.vmap(nn.construct_input_features, (0, None))
            ...
            ae, _, r_ae, r_ee = nn.construct_input_features(
