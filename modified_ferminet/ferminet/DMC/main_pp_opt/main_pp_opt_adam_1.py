...
from modified_ferminet.ferminet.DMC.loss import pploss as qmc_pp_loss_functions
...
def train(cfg: ml_collections.ConfigDict, writer_manager=None):
  ...
  local_energy_yn = pphamiltonian.local_energy(
    f=signed_network,
  ...
  local_energy = local_energy_yn

  evaluate_loss = qmc_pp_loss_functions.make_loss(
