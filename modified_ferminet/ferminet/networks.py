...
from modified_ferminet.ferminet import jastrows
from modified_ferminet.ferminet import JastrowPade
from modified_ferminet.ferminet import network_blocks
import jax
...
def make_fermi_net_layers(
  ...
  def apply_layer_y(params: Mapping[str, ParamTree], y_one: jnp.array,):
        residual = lambda x, y: (x + y) / jnp.sqrt(2.0) if x.shape == y.shape else y
