...
KineticEnergy = Callable[
    [networks.ParamTree, networks.GaussianNetData], jnp.ndarray
]
...
def local_energy(
  ...
  def _e_l(
      params: networks.ParamTree, key: chex.PRNGKey, data: networks.GaussianNetData
  ) -> Tuple[jnp.ndarray, Optional[jnp.ndarray]]:
