...
from AIQMC.pseudopotential import pp_energy_test
from AIQMC.pseudopotential import pseudopotential
...
KineticEnergy = Callable[[nn.ParamTree, nn.FermiNetData], jnp.ndarray]
...
def local_energy(
    ...
    def _e_l(params: nn.ParamTree,
             key: chex.PRNGKey,
             data: nn.FermiNetData) -> Tuple[jnp.ndarray, Optional[jnp.ndarray]]:
