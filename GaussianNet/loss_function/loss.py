...
class LossFn(Protocol):
    def __call__(
            ...
            key: chex.PRNGKey,
            data: networks.GaussianNetData, ) -> Tuple[jnp.ndarray, AuxiliaryLossData]:
...
def make_loss(network: networks.LogGaussianNetLike,
  ...
  batch_local_energy = vmap(
      ...
      in_axes=(
          None,
          0,
          networks.GaussianNetData(positions=0, spins=0, atoms=0, charges=0),
      ),
      out_axes=(0, 0)
  )
